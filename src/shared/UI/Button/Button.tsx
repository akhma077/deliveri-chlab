...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    { children, variant = ButtonVariant.Black, isFullWidth, size, type = 'button', ...props },
    ref,
  ) => {
    ...
    return (
      <button
        ...
        className={classNames(styles.button, {
          ...
          [styles.buttonAddProdVariant]: variant === ButtonVariant.AddProd,
          [styles.buttonBlackVariant]: variant === ButtonVariant.Black,
          [styles.buttonSizeMedium]: size === ButtonSize.Medium,
          [styles.buttonSignInHeaderVariant]: variant === ButtonVariant.SignInHeader,
