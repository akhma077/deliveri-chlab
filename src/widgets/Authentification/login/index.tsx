  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
      ...
      <div className={styles.error}>
        {errors?.Email && <HelperText message="Проверьте данное поле" isError />}
      </div>
      ...
      <div className={styles.error}>
        {errors?.Password && <HelperText message="Проверьте данное поле" isError />}
      </div>
      ...
      <div className={styles.bott}>
        У вас нет аккаунта? <div onClick={() => navigate('/register')}>Зарегистрироваться</div>
      </div>
    </form>
  );
};
