...
export const Road: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const moveBike1 = () => {
      ...
      const bikeX1 = currentLineLeft1 + currentLine1.clientWidth / 2 - bikeWidth / 2 - roadLeft;
    ...
    const moveBike2 = () => {
      ...
      const bikeX2 = currentLineLeft2 + currentLine2.clientWidth / 2 - bikeWidth / 2 - roadLeft;
  ...
  return (
    <div className={styles.road} ref={roadRef}>
      ...
      <div className={classNames(styles.bike, styles.bike1)} ref={bike1Ref}></div>
      <div className={classNames(styles.bike, styles.bike2)} ref={bike2Ref}></div>
    </div>
  );
};
